  ...
  return (
    <section className="greetings">
      <div className="greetings-left">
        ...
        <img src="/static/images/greetings-image.svg" alt="" className="greetings-left-mobileDecorationImage"/>
      </div>
      ...
      <div className="greetings-mobileBottom">
        <p className="greetings-mobileBottom-text">
          Информационно-техническое сообщество Финуниверситета — 
          объединяем студентов, которые развиваются в IT, дизайне 
          и медиа через реальные задачи.
        </p>
        ...
        <div className="greetings-mobileBottom-buttonContainer">
          <Button 
            type={"button-dark"}
            link={""} 
            text={"хочу вступить"} 
